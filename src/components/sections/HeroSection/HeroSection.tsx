    ...
    >
      ...
      <div className="flex flex-col-reverse items-center lg:justify-between lg:flex-row relative w-full justify-start">
        ...
        >
          ...
          <div className="min-h-[70vh] sm:min-h-[85vh] flex flex-col justify-center py-6 scroll-snap-start relative">
          ...
          {isMobile && (
            <div className="-z-1 scale-[0.7] botoom-32 xs:bottom-36 flex right-44 justify-end items-center relative w-full">
              <RightSection />
