...
export const HeroSection = (_props: HeroSectionProps) => {
  ...
  <div className="flex flex-col items-center max-w-full overflow-visible">
    ...
    <div className="w-full flex justify-center md:justify-start absolute top-8 md:top-2 md:-right-11 pb-6 sm:pb-0 sm:p-2 max-w-[500px]">
  <img
    src="/images/vultr1.png"
    alt="Vultr Logo"
    loading="lazy"
    className="w-[90px] sm:w-28 md:w-56 object-contain -ml-2 sm:ml-0"
  />
</div>



<h1 className="text-sm sm:text-xl font-extrabold leading-tight text-blue-800 text-center max-w-full mt-3 sm:mt-0 md:mt-4">
  presents
</h1>
  ...
  <p className="text-sm sm:text-base mb-6 text-[#333333] leading-relaxed font-bold text-center">
    National-level hackathon for undergraduate engineering students
  </p>
...
>
  ...
  <div className="absolute left-0 top-0 h-full w-0 bg-[#000f1d] group-hover:w-full"></div>
          ...
          {isMobile && (
   <div className="-z-1 scale-[0.5] absolute left-1 sm:right-0 justify-end items-center -mt-[95px] sm:mt-0 w-full">
