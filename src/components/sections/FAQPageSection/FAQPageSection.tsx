        ...
        <ul className="flex flex-col gap-4 w-full" role="list">
          {faqItems.map((item, idx) => (
            ...
            >
              ...
              <div
                id={`faq-answer-${idx}`}
                className={`transition-all duration-500 ease-in-out px-5 ${activeIndex === idx ? ' min-h-[120px] xs:min-h-[400px] h-full py-4 opacity-100' : 'max-h-0 py-0 opacity-0'} overflow-hidden text-gray-700 text-base h-full md:text-md bg-gray-50 w-full`}
